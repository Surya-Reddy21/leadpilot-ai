...
function App() {
  ...
  const loadAdminData = async () => {
    try {
      ...
      const leadData = (await leadRes.json()) as LeadItem[]
      const bookingData = (await bookingRes.json()) as BookingItem[]
      const ticketData = (await ticketRes.json()) as TicketItem[]
